...
void CPicture::LoadBitmap(TCHAR *szFileName)
{
	if (m_hBitmap)
	{
		DeleteObject(m_hBitmap);
...
void CPicture::LoadBitmap(TCHAR *szFileName, COLORREF clTransparent)
{
...
void CPicture::DrawBitmap(HDC hdcDest, int nXOriginDest, int nYOriginDest, int nWidthDest, int nHeightDest, int nXOriginSrc, int nYOriginSrc)
{
	//透明贴图
